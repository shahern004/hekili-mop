...
-- MoP compatibility: Define PowerType constants if Enum.PowerType doesn't exist
if not _G.Enum or not _G.Enum.PowerType then
    _G.Enum = _G.Enum or {}
    _G.Enum.PowerType = {
        HealthCost = -2,
        None = -1,
...
local ResourceInfo = {
    ...
    -- essence         = Enum.PowerType.Essence, -- MoP: Not available
...
local Specializations = {
    ...
    priest_holy = 257,
    priest_shadow = 258,    rogue_assassination = 259,
    rogue_combat = 260,
    rogue_subtlety = 261,
    ...
    -- MoP: Removed Demon Hunter and Evoker (not available in MoP)
}


local SpecializationKeys = {
    -- Classes (for MoP - no Demon Hunter or Evoker)
    [1] = "warrior",
    [2] = "paladin",
    [3] = "hunter",
    [4] = "rogue",
    ...
    [10] = "monk",
    [11] = "druid",
    -- MoP: Removed [12] = "demonhunter" and [13] = "evoker" (not available in MoP)

    [41] = "fire",    [61] = "frost",
    -- MoP Mage Specializations
    [62] = "arcane",          -- Arcane Mage (MoP)
    [63] = "fire",            -- Fire Mage (MoP)
    [64] = "frost",           -- Frost Mage (MoP)
    -- MoP Paladin Specializations  
    [65] = "holy",            -- Holy Paladin (MoP)
    [66] = "protection",      -- Protection Paladin (MoP)    [70] = "retribution",     -- Retribution Paladin (MoP)
    -- MoP Warrior Specializations
    [71] = "arms",            -- Arms Warrior (MoP)
    [72] = "fury",            -- Fury Warrior (MoP)
    [73] = "protection",      -- Protection Warrior (MoP)
    [81] = "arcane",
    -- MoP Druid Specializations
    [102] = "balance",        -- Balance Druid (MoP)
    [103] = "feral",          -- Feral Druid (MoP)
    [104] = "guardian",       -- Guardian Druid (MoP)
    [105] = "restoration",    -- Restoration Druid (MoP)
    [161] = "arms",
    [163] = "protection",
    [164] = "fury",
    [181] = "combat",
    ...
    [201] = "discipline",
    [202] = "holy",    [203] = "shadow",
    -- MoP Death Knight Specializations
    [250] = "blood",          -- Blood Death Knight (MoP)
    [251] = "frost",          -- Frost Death Knight (MoP)
    [252] = "unholy",         -- Unholy Death Knight (MoP)
    -- MoP Hunter Specializations
    [253] = "beast_mastery",  -- Beast Mastery Hunter (MoP)
    [254] = "marksmanship",   -- Marksmanship Hunter (MoP)    [255] = "survival",       -- Survival Hunter (MoP)
    -- MoP Priest Specializations
    [256] = "discipline",     -- Discipline Priest (MoP)
    [257] = "holy",           -- Holy Priest (MoP)    [258] = "shadow",         -- Shadow Priest (MoP)
    -- MoP Rogue Specializations
    [259] = "assassination",  -- Assassination Rogue (MoP)
    [260] = "combat",         -- Combat Rogue (MoP)    [261] = "subtlety",       -- Subtlety Rogue (MoP)
    -- MoP Shaman Specializations
    [262] = "elemental",      -- Elemental Shaman (MoP)
    [263] = "enhancement",    -- Enhancement Shaman (MoP)    [264] = "restoration",    -- Restoration Shaman (MoP)
    -- MoP Warlock Specializations
    [265] = "affliction",     -- Affliction Warlock (MoP)
    [266] = "demonology",     -- Demonology Warlock (MoP)
    [267] = "destruction",    -- Destruction Warlock (MoP)
    [268] = "brewmaster",     -- Brewmaster Monk (MoP)
    [269] = "windwalker",     -- Windwalker Monk (MoP)
    [270] = "mistweaver",     -- Mistweaver Monk (MoP)
    [281] = "feral",
    [282] = "restoration",
    [283] = "balance",
    [301] = "destruction",
...
ns.getSpecializationID = function ( index )
    local GetSpecializationInfo = GetSpecializationInfo or function(specIndex)
        -- Fallback for MoP compatibility - see Events.lua for full implementation
        return 0, "Unknown", nil, nil, nil, (select(2, UnitClass("player")))
    end
...
local function initTalentMappings()
    ...
    ns.WrathTalentToSpellID = WrathTalentToSpellID
    end
end