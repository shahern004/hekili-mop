...
-- Enhanced implementation with comprehensive MoP Arcane mechanics
...
spec:RegisterGlyphs( {
    ...
    [57926] = "Glyph of Deep Freeze - Your Deep Freeze spell no longer causes damage but its cooldown is reduced by 50%",
    [56372] = "Glyph of Polymorph - Your Polymorph removes all damage over time effects from the target",
    [64276] = "Glyph of Combustion - Combustion spreads to one additional nearby enemy within 10 yards",
    ...
    [56367] = "Glyph of Dragon's Breath - Reduces the cooldown of Dragon's Breath by 10 seconds",
    ...
    [56377] = "Glyph of Blast Wave - Reduces the cooldown of Blast Wave by 15 seconds",
    [56379] = "Glyph of Impact - Increases the chance for your Fire Blast to stun by 100% but reduces damage by 75%",
